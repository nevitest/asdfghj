...
```
npm create cloudflare@latest -- --template=cloudflare/templates/icy-haze-7511
```

## Preview Deployment

A live public deployment of this template is available at [https://icy-haze-7511.templates.workers.dev](https://icy-haze-7511.templates.workers.dev)
